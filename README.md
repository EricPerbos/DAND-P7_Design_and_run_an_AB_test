#Udacity website: improving "Start free trial" conversion rate through A/B test
...
The data for you to analyze is [here](data/Calculations.xls). This data contains the raw information needed to compute the above metrics, broken down day by day. Note that there are two sheets within the spreadsheet - one for the experiment group, and one for the control group.  
